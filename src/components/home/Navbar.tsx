  ...
  return (
    <header className="fixed top-6 left-0 right-0 z-50 flex w-full justify-center pointer-events-none px-3 sm:px-4">
      ...
      <nav className="flex w-full max-w-[800px] items-center justify-between gap-3 rounded-full border border-white/20 bg-black/60 backdrop-blur-xl px-4 sm:px-5 py-2.5 shadow-[0_22px_70px_rgba(0,0,0,0.85)] mx-auto pointer-events-auto">
        ...
        <Link
          href="/"
          className="group flex items-center rounded-full px-2 sm:px-3 py-1.5 transition-transform duration-200 hover:scale-[1.02]"
        >
        ...
        <div className="hidden items-center gap-7 text-[11px] font-bold text-white/70 md:flex">
          <Link
            href="/"
            className="relative pb-0.5 transition-colors duration-200 hover:text-[#D4AF37]"
          >
            HOME
        ...
        <div className="flex items-center gap-2">
            ...
            <div className="hidden items-center gap-3 sm:flex">
              {user ? (
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    {isUserMenuOpen && (
                      <div className="absolute right-0 top-full mt-2 w-48 rounded-2xl border border-white/15 bg-black/95 backdrop-blur-xl px-2 py-2 shadow-[0_22px_60px_rgba(0,0,0,0.9)]">
                        <Link
                          href="/my_profile"
                          className="flex items-center gap-2 rounded-xl px-3 py-2 text-[11px] font-semibold text-white/85 transition-colors duration-200 hover:bg-white/10 hover:text-[#D4AF37]"
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-[11px] font-semibold text-white/85 transition-colors duration-200 hover:bg-white/10 hover:text-red-400"
                        >
                ...
                <>
                  <Link
                    href="/login"
                    className="rounded-full border border-white/16 bg-white/5 px-3.5 py-1.5 text-[11px] font-semibold text-white/85 shadow-[0_10px_26px_rgba(0,0,0,0.35)] transition-all duration-200 hover:border-[#D4AF37]/70 hover:bg-white/10 hover:text-[#f6e6b0] hover:-translate-y-px active:translate-y-0"
                  >
                    Login
                  </Link>
                  <Link
                    href="/signup"
                    className="inline-flex items-center gap-1 rounded-full bg-[#D4AF37] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-white shadow-[0_16px_40px_rgba(212,175,55,0.55)] transition-all duration-200 hover:bg-[#e3c55d] hover:-translate-y-px active:translate-y-0"
                  >
                    Signup
                  </Link>
                </>
          ...
          <button
            ...
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/25 bg-black/60 text-white/85 shadow-[0_10px_26px_rgba(0,0,0,0.5)] transition-all duration-200 hover:border-[#D4AF37]/70 hover:text-[#f6e6b0] md:hidden"
          >
        ...
        <div className="absolute top-[72px] left-0 right-0 z-40 px-3 sm:px-4 md:hidden pointer-events-none">
          <div className="mx-auto w-full max-w-[800px] rounded-3xl border border-white/15 bg-black/85 px-4 py-4 shadow-[0_22px_60px_rgba(0,0,0,0.9)] backdrop-blur-xl pointer-events-auto">
            <div className="flex flex-col gap-3 text-sm text-white/85">
              <Link
                href="/"
                className="rounded-2xl px-3 py-2 font-semibold tracking-[0.18em] uppercase hover:bg-white/5 hover:text-[#D4AF37] transition-colors"
